...
- Location: tests\Hooks.spec.js:58:8
...
Call log:
  - waiting for getByText(' Login1').nth(1)
...
```ts
  ...
  56  |   });
  57  | 
  58  |   test.only("Authencation test", async ({ page }) => {
...
> 71  |       await page.getByText(" Login1").nth(1).click();
      |                                              ^ Error: locator.click: Test timeout of 45000ms exceeded.
  72  |     });
  73  | 
